import {
  ...
  u as bn,
  x as h,
} from "./@dnd-kit/accessibility-BA1htokQ.js";
...
import {
  ...
  s as useNavigate,
  t as Link,
  u as useHashLocation,
} from "./wouter-ByZHtXYD.js";
import {
  a as atom,
  i as useSetAtom,
  n as useAtom,
...
import {
  ...
  t as DndContext,
  u as useSensors,
} from "./@dnd-kit/core-DUUonhBk.js";
import {
  n as useSortable,
  r as verticalListSortingStrategy,
  t as SortableContext,
} from "./@dnd-kit/sortable-zYN-0ANI.js";
...
function migrate(event) {
  ...
  if (event.oldVersion < 1) {
    db.createObjectStore("actions", { keyPath: "uuid" });
  }
...
function syncNextAction({ db, client, log }) {
  return new Promise((resolve, reject) => {
    const request = db.transaction("actions", "readonly").objectStore("actions")
      .openCursor();
    request.onsuccess = async (event) => {
      ...
      db.transaction("actions", "readwrite").objectStore("actions").delete(
        primaryKey,
      );
      resolve(true);
    };
  ...
  async send(action) {
    if (this.db) {
      return await promisify(
        this.db.transaction("actions", "readwrite").objectStore("actions").put(
          action,
        ),
      );
...
function toast(render) {
  toast$1.custom((id) =>
    /* @__PURE__ */ u(S, { children: render(() => toast$1.dismiss(id)) })
  );
}
...
function Version() {
  return /* @__PURE__ */ u("ul", {
    children: [
      /* @__PURE__ */ u("li", { children: ["Version: ", "2026-08-01_0"] }),
      /* @__PURE__ */ u("li", { children: ["Git Commit: ", "20d9dc4"] }),
    ],
  });
}
...
var gotItemsAtom = atom((get) => {
  return Object.values(get(storeItemsAtom)).filter((item) => item.got).sort((
    a,
    b,
...
var loadStoreAtom = atom(null, async (get, set, storeId) => {
  ...
  const actions = await promisify(
    (await openIndexedDB()).transaction("actions").objectStore("actions").index(
...
var handleKeydownAtom = atom(null, (get, set, event) => {
  ...
  if (event.code == "Enter") {
    if (focusIndex === -1 || focusIndex === needItems.length - 1) {
      ...
      const order =
        (needItems[focusIndex].order + needItems[focusIndex + 1].order) / 2;
      set(applyAndSyncAtom, {
        op: "new",
        table: "store_items",
        entity: {
    ...
    set(focusIndexAtom, (i) => Math.min(get(needItemsAtom).length - 1, i + 1));
...
var handleDragEndAtom = atom(null, (get, set, event) => {
  ...
  if (newIndex === 0) newOrder = items[0].order - 1e3;
    ...
    newOrder = items[items.length - 1].order + 1e3;
...
function ago(item, now) {
  const days = (now.valueOf() - item.last_got_at.valueOf()) / 1e3 / 60 / 60 /
    24;
...
function Grip(props) {
  ...
  return /* @__PURE__ */ u("div", {
    ...
    children: /* @__PURE__ */ u("img", {
      src: "/grocery-shopping/grip-bars.svg",
    }),
  });
}
  ...
  return /* @__PURE__ */ u(S, {
    children: [
      ...
      /* @__PURE__ */ u("div", {
        ...
        children: stores.filter((s) => s.name).map((s) =>
          /* @__PURE__ */ u(Link, {
...
function App() {
  return /* @__PURE__ */ u(SyncActionProvider, {
    mode: SYNC_MODE,
    children: /* @__PURE__ */ u(HashRouter, {
      children: /* @__PURE__ */ u("div", {
        ...
        children: [
          /* @__PURE__ */ u("h1", {
            ...
            children: [
              /* @__PURE__ */ u("div", {
                children: /* @__PURE__ */ u(LoginPrompt, {}),
              }),
              /* @__PURE__ */ u("div", {
...
if (ENABLE_SERVICE_WORKER) {
  navigator.serviceWorker.register("/grocery-shopping/service-worker.js").catch(
    console.error,
  );
}
createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ u(S, { children: /* @__PURE__ */ u(App, {}) }),
);
