...
import {
  ...
  c as useDroppable,
  d as CSS,
  f as isKeyboardEvent,
  h as useUniqueId,
  m as useIsomorphicLayoutEffect,
  n as KeyboardCode,
  o as useDndContext,
  p as useCombinedRefs,
  s as useDraggable,
} from "./core-DUUonhBk.js";
...
var verticalListSortingStrategy = (_ref) => {
  ...
  const activeNodeRect = (_rects$activeIndex = rects[activeIndex]) != null
    ? _rects$activeIndex
    : fallbackActiveRect;
  ...
  if (index === activeIndex) {
    ...
    return {
      ...
      y: activeIndex < overIndex
        ? overIndexRect.top + overIndexRect.height -
...
function useSortable(_ref) {
  ...
  const itemsAfterCurrentSortable = T(() => items.slice(items.indexOf(id)), [
    items,
    id,
  ]);
  ...
  const displaceItem = isSorting && !disableTransforms &&
    isValidIndex(activeIndex) && isValidIndex(overIndex);
  const shouldDisplaceDragSource = !useDragOverlay && isDragging;
  const dragSourceDisplacement = shouldDisplaceDragSource && displaceItem
    ? transform
    : null;
...
function normalizeLocalDisabled(localDisabled, globalDisabled) {
  ...
  return {
    draggable:
      (_localDisabled$dragga = localDisabled == null
          ? void 0
          : localDisabled.draggable) != null
        ? _localDisabled$dragga
        : globalDisabled.draggable,
    droppable:
      (_localDisabled$droppa = localDisabled == null
          ? void 0
          : localDisabled.droppable) != null
...
//#endregion
export {
  SortableContext as t,
  useSortable as n,
  verticalListSortingStrategy as r,
};
