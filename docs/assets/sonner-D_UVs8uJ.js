...
var Loader = ({ visible, className }) => {
  return /*#__PURE__*/ gn.createElement(
    "div",
    {
...
var SuccessIcon = /*#__PURE__*/ gn.createElement(
  "svg",
  {
...
var WarningIcon = /*#__PURE__*/ gn.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 24 24",
...
var InfoIcon = /*#__PURE__*/ gn.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
var ErrorIcon = /*#__PURE__*/ gn.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 20 20",
...
var CloseIcon = /*#__PURE__*/ gn.createElement(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "12",
...
var Observer = class {
  constructor() {
    ...
    this.create = (data) => {
      ...
      const id = typeof (data == null ? void 0 : data.id) === "number" ||
    ...
    this.promise = (promise, data) => {
      ...
      if (data.loading !== void 0) {
        id = this.create({
          ...
          description: typeof data.description !== "function"
            ? data.description
            : void 0,
        });
      }
      ...
      const originalPromise = p.then(async (response) => {
        ...
        if (gn.isValidElement(response)) {
          ...
          const description = typeof data.description === "function"
            ...
            : data.description;
          const toastSettings =
            typeof promiseData === "object" && !gn.isValidElement(promiseData)
              ? promiseData
              : { message: promiseData };
          this.create({
            id,
...
var isHttpResponse = (data) => {
  return data && typeof data === "object" && "ok" in data &&
    typeof data.ok === "boolean" && "status" in data &&
...
var Toast = (props) => {
  ...
  offset.current = gn.useMemo(() => heightIndex * gap + toastsHeightBefore, [
    heightIndex,
    toastsHeightBefore,
  ]);
  gn.useEffect(() => {
  ...
  gn.useLayoutEffect(() => {
    ...
    setHeights((heights) => {
      ...
      } else {return heights.map((height) =>
  ...
  gn.useEffect(() => {
    if (
      toast.promise && toastType === "loading" || toast.duration === Infinity ||
      toast.type === "loading"
    ) return;
    let timeoutId;
    const pauseTimer = () => {
      if (lastCloseTimerStartTimeRef.current < closeTimerStartTimeRef.current) {
        const elapsedTime = (/* @__PURE__ */ new Date()).getTime() -
          closeTimerStartTimeRef.current;
        remainingTime.current = remainingTime.current - elapsedTime;
      }
      lastCloseTimerStartTimeRef.current = (/* @__PURE__ */ new Date())
        .getTime();
    };
    const startTimer = () => {
  ...
  const icon = toast.icon || (icons == null ? void 0 : icons[toastType]) ||
    getAsset(toastType);
  ...
  return /*#__PURE__*/ gn.createElement(
    "li",
    {
      ...
      "data-sonner-toast": "",
      "data-rich-colors": (_toast_richColors = toast.richColors) != null
        ? _toast_richColors
        : defaultRichColors,
      ...
      onPointerUp: () => {
        ...
        const swipeAmountX = Number(
          ((_toastRef_current = toastRef.current) == null
            ? void 0
            : _toastRef_current.style.getPropertyValue("--swipe-amount-x")
              .replace("px", "")) || 0,
        );
        const swipeAmountY = Number(
          ((_toastRef_current1 = toastRef.current) == null
            ? void 0
            : _toastRef_current1.style.getPropertyValue("--swipe-amount-y")
              .replace("px", "")) || 0,
        );
        const timeTaken = (/* @__PURE__ */ new Date()).getTime() -
          ((_dragStartTime_current = dragStartTime.current) == null
            ? void 0
            : _dragStartTime_current.getTime());
        const swipeAmount = swipeDirection === "x"
          ? swipeAmountX
          : swipeAmountY;
      ...
      onPointerMove: (event) => {
        ...
        if (
          !swipeDirection && (Math.abs(xDelta) > 1 || Math.abs(yDelta) > 1)
        ...
        if (swipeDirection === "y") {
          if (
            ...
            if (
              ...
              swipeAmount.y = Math.abs(dampenedDelta) < Math.abs(yDelta)
                ? dampenedDelta
                : yDelta;
            }
          }
          ...
          if (
            ...
            if (
              ...
              swipeAmount.x = Math.abs(dampenedDelta) < Math.abs(xDelta)
                ? dampenedDelta
                : xDelta;
            }
          }
    ...
    closeButton && !toast.jsx && toastType !== "loading"
      ...
      : null,
    (toastType || toast.icon || toast.promise) && toast.icon !== null &&
    ...
    /*#__PURE__*/ gn.isValidElement(toast.cancel)
      ? toast.cancel
      ...
      : null,
    /*#__PURE__*/ gn.isValidElement(toast.action)
      ? toast.action
  ...
  [defaultOffset, mobileOffset].forEach((offset, index) => {
    ...
    function assignAll(offset) {
      [
        ...
        styles[`${prefix}-${key}`] = typeof offset === "number"
          ? `${offset}px`
          : offset;
      });
    }
    if (typeof offset === "number" || typeof offset === "string") {
      ...
      [
        ...
        else {styles[`${prefix}-${key}`] = typeof offset[key] === "number"
            ? `${offset[key]}px`
            : offset[key];}
      });
...
var Toaster = /*#__PURE__*/ gn.forwardRef(function Toaster(props, ref) {
  ...
  const possiblePositions = gn.useMemo(() => {
    return Array.from(
      new Set([position].concat(
        filteredToasts.filter((toast) => toast.position).map((toast) =>
          toast.position
        ),
      )),
    );
  ...
  const [actualTheme, setActualTheme] = gn.useState(
    theme !== "system"
      ? theme
  ...
  const hotkeyLabel = hotkey.join("+").replace(/Key/g, "").replace(
    /Digit/g,
    "",
  );
  ...
  const removeToast = gn.useCallback((toastToRemove) => {
    setToasts((toasts) => {
      var _toasts_find;
      if (
        !((_toasts_find = toasts.find((toast) =>
  ...
  gn.useEffect(() => {
    return ToastState.subscribe((toast) => {
      ...
      setTimeout(() => {
        gn.flushSync(() => {
          setToasts((toasts) => {
            const indexOfExistingToast = toasts.findIndex((t) =>
              t.id === toast.id
            );
    ...
    possiblePositions.map((position, index) => {
      ...
      return /*#__PURE__*/ gn.createElement(
        "ol",
        {
          ...
          style: {
            "--front-toast-height": `${
              ((_heights_ = heights[0]) == null ? void 0 : _heights_.height) ||
              0
            }px`,
        ...
        filteredToasts.filter((toast) =>
          ...
          return /*#__PURE__*/ gn.createElement(Toast, {
            ...
            duration: (_toastOptions_duration = toastOptions == null
                ? void 0
                : toastOptions.duration) != null
              ? _toastOptions_duration
              : duration,
            className: toastOptions == null ? void 0 : toastOptions.className,
            descriptionClassName: toastOptions == null
              ? void 0
              : toastOptions.descriptionClassName,
            invert,
            visibleToasts,
            closeButton: (_toastOptions_closeButton = toastOptions == null
                ? void 0
            ...
            cancelButtonStyle: toastOptions == null
              ? void 0
              : toastOptions.cancelButtonStyle,
            actionButtonStyle: toastOptions == null
              ? void 0
              : toastOptions.actionButtonStyle,
            closeButtonAriaLabel: toastOptions == null
              ? void 0
              : toastOptions.closeButtonAriaLabel,
            removeToast,
            toasts: filteredToasts.filter((t) =>
