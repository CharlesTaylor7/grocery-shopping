...
import { t as Temporal } from "./temporal-polyfill-vuPi0AXk.js";
...
function Version() {
	return /* @__PURE__ */ u("ul", { children: [/* @__PURE__ */ u("li", { children: ["Version: ", "2026-08-01_1"] }), /* @__PURE__ */ u("li", { children: ["Git Commit: ", "eb5dfbe"] })] });
}
...
init({
	dsn: SENTRY_DSN,
	release: "2026-08-01_1",
	initialScope: { tags: { git_commit: "eb5dfbe" } }
});
