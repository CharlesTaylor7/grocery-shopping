...
import { type ComponentType, useRef, useState } from "preact/compat";
import { toast } from "sonner";

import { buttonVariants } from "@/islands/shadcn/components/ui/button";
import { Calendar } from "@/islands/shadcn/components/ui/calendar";
import { Checkbox } from "@/islands/shadcn/components/ui/checkbox";
import {
  Combobox,
  ComboboxContent,
  ComboboxEmpty,
  ...
  ComboboxItem,
  ComboboxList,
} from "@/islands/shadcn/components/ui/combobox";
import {
  Field,
  FieldContent,
  FieldError,
  FieldLabel,
} from "@/islands/shadcn/components/ui/field";
import { Input } from "@/islands/shadcn/components/ui/input";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupInput,
} from "@/islands/shadcn/components/ui/input-group";
import { Label } from "@/islands/shadcn/components/ui/label";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@/islands/shadcn/components/ui/popover";
import {
  Select,
  SelectContent,
  SelectItem,
  SelectTrigger,
  SelectValue,
} from "@/islands/shadcn/components/ui/select";
import { Slider } from "@/islands/shadcn/components/ui/slider";
import { Switch } from "@/islands/shadcn/components/ui/switch";
import { Textarea } from "@/islands/shadcn/components/ui/textarea";
...
function InputField({ name, field, isPending }: AdditionalFieldProps) {
  ...
  const nativeInputMode = isNumeric
    ? maxFractionDigits ? "decimal" : "numeric"
    : undefined;
...
function SliderField({ name, field, isPending }: AdditionalFieldProps) {
  ...
  const step = field.step ??
    (maxFractionDigits ? 1 / 10 ** maxFractionDigits : 1);
