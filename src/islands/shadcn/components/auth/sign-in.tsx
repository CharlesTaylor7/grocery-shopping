...
import {
  ...
  CardHeader,
  CardTitle,
} from "@/islands/shadcn/components/ui/card";
...
export function SignIn({
  ...
  const handleSubmit: GenericEventHandler<HTMLFormElement> = (e) => {
    e.preventDefault();
  ...
  const showSeparator = emailAndPassword?.enabled && socialProviders &&
